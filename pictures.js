...
(function(){
  ...
  //var photos = window.gallery.createPhotos(DESCRIPTION_ARRAY_LENGTH);
  ...
  usersPicturesList.appendChild(renderPictures(DESCRIPTION_ARRAY_LENGTH, window.gallery.photos));
